...
public class ShareAndRate : MonoBehaviour
{
 ...
 private static extern void sampleTextMethod (string message);
  ...
  body = "Hey, I just scored " + scoreManager.ScoreText.text + " in this cool game called BioInvaders! Play it now at https://play.google.com/store/apps/details?id=com.fx.bioinvaders";
